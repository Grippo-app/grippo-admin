...
/**
 * LoginView — управляет login overlay.
 *
 * Слушает:
 *   AUTH_LOGIN_SUCCESS   → hide overlay
 *   AUTH_LOGOUT          → show overlay
 *   AUTH_SESSION_EXPIRED → show overlay + toast
 *
 * Эмитит:
 *   (none — вызывает AuthService.login() напрямую)
 */
