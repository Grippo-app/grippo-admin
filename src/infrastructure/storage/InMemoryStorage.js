...
export class InMemoryStorage {
  ...
  setViewMode(v)        { this._viewMode = v; }
  getUserId()           { return this._userId; }
  setUserId(v)          { this._userId = v || ''; }
  getProfileId()        { return this._profileId; }
  setProfileId(v)       { this._profileId = v || ''; }
  clearUserInfo()       { this._userId = ''; this._profileId = ''; }
  loadUserInfo()        { return { id: this._userId, profileId: this._profileId }; }
  getRefreshToken()     { return this._refreshToken; }
  setRefreshToken(v)    { this._refreshToken = v || ''; }
  clearRefreshToken()   { this._refreshToken = ''; }
  loadEditedSet()       { return new Set(this._editedSet); }
  persistEditedSet(set) { this._editedSet = new Set(set || []); }
}
