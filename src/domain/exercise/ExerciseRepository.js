...
/**
 * ExerciseRepository — HTTP CRUD для exercise examples и словарей.
 *
 * Принимает ApiClient как зависимость (Dependency Inversion).
 * Не знает о токенах — это дело ApiClient._fetch().
 */
